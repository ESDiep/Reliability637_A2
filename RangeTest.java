...
public class RangeTest {
  ...
  //Partition: positive range, lower bound = upper bound
   ...
   @Test
   //partition: positive range (2,10) middle value: 6
   ...
   @Test
   //Partition negative range (-10,-2), middle value: -6
   ...
   @Test
   //Partition: extreme range (-Min, Max), middle value: 0
   ...
   //invalid range (10, 0) lower bound > upper bound
   @Test(expected =	IllegalArgumentException.class)
   ...
   @Test
   //Partition: positive float range (2.234, 10.235)
